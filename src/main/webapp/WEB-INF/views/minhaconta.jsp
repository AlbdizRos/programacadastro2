...
<body>
	...
	<div class="container mt-3">
		...
		<form id="formEdicao" action="atualizar-senha" method="post">
			...
			<div class="mb-3">
				<div>Usuário Autenticado: <strong>${usuario_auth.nome}</strong></div>
				<div>E-mail: <strong>${usuario_auth.email}</strong></div>
			</div>
			
			<div class="row mb-3">
				<div class="col-md-3">
					<label>Nova Senha:</label>
					<form:input path="model.senha" type="password" id="senha" name="senha" class="form-control" placeholder="Digite aqui"/>
				</div>
				<div class="col-md-3">
					<label>Confirme a Senha:</label>
					<form:input path="model.senhaConfirmacao" type="password" id="senhaConfirmacao" name="senhaConfirmacao" class="form-control" placeholder="Digite aqui"/>
				</div>				
			</div>
